...
submitButton.addEventListener('click', function(event) {
    ...
    if (validateForm()) {
        alert("Inscription étudiant réussie !"); // Ajout d'une alerte de confirmation
        window.location.href = 'accueil_etu.html';  // Redirige vers la page étudiant
    } else {
        alert("Veuillez corriger les erreurs avant de soumettre.");
    }
});

// Ajouter une alerte lors de la déconnexion
