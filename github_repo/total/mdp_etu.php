...
if (!isset($_SESSION['id']) || ($_SESSION['role'] !== 'etudiant' && $_SESSION['role'] !== 'pilote')) {
    die("Accès refusé.");
}
   ...
   <head> 
    ...
    <header>
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="modifierprofil_etu.php">modifier_mon_profil </a></li>
                <li class="breadcrumb-item"><a href="mdp_etu.php">mot_de_passe </a></li>
            </ol>
        </nav>
     </header>
    ...
    <footer class="footer">
      <div class="footer-container">
        ...
        <div class="footer-column">
          <h3>Coordonnées</h3>
          <a  style='color:#ffffff'href="https://www.google.fr/maps/place/Campus+CESI/@43.5792319,3.9432547,794m">Immeuble Le Quatrième Zone Aéroportuaire, 34130 Mauguio</a>
